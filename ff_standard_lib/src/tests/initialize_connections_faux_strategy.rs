...
use crate::standardized_types::enums::{MarketType, StrategyMode, PrimarySubscription};
...
pub(crate) fn initialize_tests() -> FundForgeStrategy {
    ...
    tokio::runtime::Runtime::new().unwrap().block_on(async {
        FundForgeStrategy::initialize(
            ...
            Duration::hours(1),
            vec![
                (Some(PrimarySubscription::new(Resolution::Minutes(1), BaseDataType::QuoteBars)), DataSubscription::new_custom(SymbolName::from("EUR-USD"), DataVendor::DataBento, Resolution::Minutes(3), MarketType::Forex, CandleType::HeikinAshi), None),
            ],
            false,
            100,
