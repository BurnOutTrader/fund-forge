...
impl VendorApiResponse for DataVendor {
    async fn symbols_response(
        ...
        match self {
            ...
            DataVendor::Test => return TEST_CLIENT.symbols_response(stream_name, market_type, callback_id).await
        }
    ...
    async fn resolutions_response(
        ...
        match self {
            ...
            DataVendor::Test => return TEST_CLIENT.resolutions_response(stream_name, market_type, callback_id).await
        }
        DataServerResponse::Error{ callback_id, error: FundForgeError::ServerErrorDebug(format!("Unable to find api client instance for: {}", self))}
    }
    ...
    async fn markets_response(
        ...
        match self {
            ...
            DataVendor::Test => return TEST_CLIENT.markets_response(stream_name, callback_id).await
        }
        DataServerResponse::Error{ callback_id, error: FundForgeError::ServerErrorDebug(format!("Unable to find api client instance for: {}", self))}
    }
    ...
    async fn decimal_accuracy_response(
        ...
        match self {
            ...
            DataVendor::Test => return TEST_CLIENT.decimal_accuracy_response(stream_name, symbol_name, callback_id).await
        }
        DataServerResponse::Error{ callback_id, error: FundForgeError::ServerErrorDebug(format!("Unable to find api client instance for: {}", self))}
    }
