...
/*    // send a heartbeat request as a test message, 'RequestHeartbeat' Template number 18
    ...
    match rithmic_api_arc.send_message(&SysInfraType::OrderPlant, &req).await {
