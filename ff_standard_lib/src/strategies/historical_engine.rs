        ...
        thread::spawn(move|| {
            ...
            tokio::runtime::Runtime::new().unwrap().block_on(async {
                ...
                match self.mode {
                    ...
                    StrategyMode::Live | StrategyMode::LivePaperTrading  => self.live_warm_up(warm_up_start_time, end_time, self.buffer_resolution).await,
                }
                ...
                match self.mode {
                    ...
                    StrategyMode::Live | StrategyMode::LivePaperTrading => {
                        TimedEventHandler::run_time_updates(self.timed_event_handler.clone()).await;
                    }
                }
            });
        });
