...
async fn receive_and_process(
    ...
    //todo, we should possibly have an option for strategies to use this fn, or a fn that implements sequential processing indicators updates at the cost of potentially having a laging data feed.
