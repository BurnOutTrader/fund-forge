...
pub async fn oanda_instruments_download(oanda_client: &OandaClient, account: &str) -> Option<Vec<OandaInstrument>>{
...
pub async fn oanda_clean_instrument(symbol_name: &SymbolName) -> SymbolName {
    symbol_name
        .replace("/", "_")
        .replace(":", "_")
        .replace("?", "_")
...
pub async fn oanda_accounts_list(oanda_client: &OandaClient) -> Result<Vec<Account>, FundForgeError> {
...
pub async fn oanda_account_summary(oanda_client: &OandaClient, account_id: &str) -> Result<AccountSummary, FundForgeError> {
