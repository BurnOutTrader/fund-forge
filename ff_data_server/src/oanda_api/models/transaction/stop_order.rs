...
use crate::oanda_api::models::transaction_related::{ClientExtensions, GuaranteedStopLossDetails, RequestID, StopLossDetails, StopOrderReason, TakeProfitDetails, TrailingStopLossDetails, TransactionID, TransactionRejectReason, TransactionType};
...
pub struct StopOrderTransaction {
    ...
    /// The Type of the Transaction. Always set to “STOP_ORDER”.
    #[serde(rename = "type")]
    ...
    /// The prices threshold specified for the Stop Order.
    #[serde(rename = "prices")]
    pub price: Decimal,

    /// The worst market prices that may be used to fill this Stop Order.
...
pub struct StopOrderRejectTransaction {
    ...
    /// The Type of the Transaction. Always set to “STOP_ORDER_REJECT”.
    #[serde(rename = "type")]
    pub type_of: TransactionType,
