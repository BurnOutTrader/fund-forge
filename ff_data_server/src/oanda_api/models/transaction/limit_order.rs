...
use crate::oanda_api::models::transaction_related::{ClientExtensions, GuaranteedStopLossDetails, LimitOrderReason, RequestID, StopLossDetails, TakeProfitDetails, TrailingStopLossDetails, TransactionID, TransactionRejectReason, TransactionType};
...
pub struct LimitOrderTransaction {
    ...
    /// The Type of the Transaction. Always set to “LIMIT_ORDER”.
    #[serde(rename = "type")]
    ...
    /// The prices threshold specified for the Limit Order.
    #[serde(rename = "prices")]
    pub price: Decimal,
...
pub struct LimitOrderRejectTransaction {
    ...
    /// The Type of the Transaction. Always set to “LIMIT_ORDER_REJECT”.
    #[serde(rename = "type")]
    pub type_of: TransactionType,
