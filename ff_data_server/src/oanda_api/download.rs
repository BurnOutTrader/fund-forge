...
pub(crate) async fn generate_urls(symbol: Symbol, resolution: Resolution, base_data_type: BaseDataType, start_time: &DateTime<Utc>) -> Vec<String> {
...
fn generate_url(start: &NaiveDateTime, end_time: &NaiveDateTime, instrument: &str, interval: &Interval, price_data_type: &BaseDataType) -> String{
