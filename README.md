...
After creating the strategy instance using `FundForgeStrategy::initialize(//strategy inputs);` we will receive data and events as an `EventTimeSlice` in our event_receiver.
