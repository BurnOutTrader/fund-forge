...
pub struct PriceScale {
    ...
    pub last_open_price: Option<Decimal>,
}
...
impl PriceScale {
    ...
    pub fn last_open_price(data: &BTreeMap<i64, Vec<SeriesData>>) -> Option<Decimal> {
    ...
    pub fn last_price(data: &BTreeMap<i64, Vec<SeriesData>>) -> Option<Decimal> {
